            ...
            Expanded(
              child: Stack(
                children: <Widget>[
                  // Gradient
                  Container(
                    decoration: BoxDecoration(gradient: _include.appGradientColor),
                  ),
                  ...
                  Container(
                    ...
                    child: Image.asset("${_include.imagesPath}landing_bg.png",
                        fit: BoxFit.fill,
                  ...
                  Container(
                    padding: EdgeInsets.only(
                      top: _include.statusBar(context),
                    ),
                    child: Column(
                      children: <Widget>[
                        // Header
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              Container(
                                ...
                                child: Image.asset("${_include.imagesPath}logo.png",
                              ...
                              Padding(
                                ...
                                child: Image.asset(
                                  "${_include.imagesPath}written-logo.png",
